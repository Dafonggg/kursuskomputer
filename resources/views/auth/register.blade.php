      ...
      <form action="{{ route('register') }}" method="POST">
        ...
        <div class="socials">
          <button type="button" class="social-btn" onclick="alert('Google login - to be implemented')">
            ...
            <p><span class="extra-text">Register with</span> Google</p>
          </button>
          <button type="button" class="social-btn" onclick="alert('Facebook login - to be implemented')">
            ...
            <p><span class="extra-text">Register with</span> Facebook</p>
          </button>
        </div>
        <span class="or"></span>
        ...
        @error('email')
          <div class="error-message">{{ $message }}</div>
        @enderror
        <input type="email" name="email_confirmation" placeholder="Konfirmasi Email" required />
        @error('email_confirmation')
          <div class="error-message">{{ $message }}</div>
        @enderror
        <input type="tel" name="phone" placeholder="Nomer Handphone" value="{{ old('phone') }}" required />
        @error('phone')
          <div class="error-message">{{ $message }}</div>
        @enderror
        ...
        <div style="text-align: center; margin-top: 16px;">
          <span style="font-size: 14px; color: #645e74;">Sudah punya akun? <a href="{{ route('login') }}" style="color: var(--color-primary); text-decoration: none; font-weight: 600;">Login</a></span>
        </div>
      </form>
    </div>
  </body>
