      ...
      <form class="auth-form" action="{{ route('register') }}" method="POST">
        ...
        <div class="auth-socials">
          <button type="button" class="auth-social-btn" onclick="alert('Google login - to be implemented')">
            ...
            <p><span class="auth-extra-text">Register with</span> Google</p>
          </button>
          <button type="button" class="auth-social-btn" onclick="alert('Facebook login - to be implemented')">
            ...
            <p><span class="auth-extra-text">Register with</span> Facebook</p>
          </button>
        </div>
        ...
        <div class="auth-link-container">
          <span class="auth-link-text">Sudah punya akun? <a href="{{ route('login') }}" class="auth-link">Login</a></span>
        </div>
      </form>
      </div>
    </div>
